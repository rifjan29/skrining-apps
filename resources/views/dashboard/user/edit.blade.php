<x-app-layout>
    ...
    <section class="content-main mb-5">
        <div class="content-header">
            <h2 class="content-title">{{ ucwords(str_replace('-',' ',Request::segment(4))) }} User</h2>
            <div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="mb-4">
                                        ...
                                        <input placeholder="Masukkan Data" type="text" value="{{ old('nama', $data->name) }}" class="form-control @error('nama') is-invalid @enderror" name="nama" />
                                        @error('nama')
                                ...
                                <div class="col-md-12">
                                    <div class="mb-4">
                                        ...
                                        <input placeholder="Masukkan Data" type="email" value="{{ old('email', $data->email) }}" class="form-control @error('email') is-invalid @enderror" name="email" />
                                        @error('email')
                                            <div class="invalid-feedback">
                                                {{$message}}.
                                            </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="d-flex flex-row">
                                            <div class="w-75">
                                                ...
                                                <small class="font-xs">Kosongin jika tidak mengganti password</small>
                                            </div>
